...
Akode.DocxGen uses the following reviewed NuGet packages.
Copyright remains with each package owner. The SPDX license
identifier shown here is the package license recorded during review.
...
| Json.More.Net | 2.2.0 | MIT |
| JsonPointer.Net | 6.0.1 | MIT |
| JsonSchema.Net | 8.0.5 | MIT |
...
| Microsoft.Extensions.Logging.Configuration | 10.0.0 | MIT |
| Microsoft.Extensions.Logging.Console | 10.0.0 | MIT |
...
The authoritative dependency gate is
`eng/package-license-allowlist.json`; CI rejects unreviewed package
IDs, versions, or licenses.
