...
| [0008](0008-template-json-schema-generation.md) | Superseded in part by ADR-0010 | Deterministic JSON Schema generation from DOCX markers |
| [0009](0009-public-product-and-package-naming.md) | Accepted | DocxGen product, Akode packages, and public naming |
| [0010](0010-template-placeholder-optionality.md) | Accepted | Placeholder structure does not imply business requiredness |
